...
class DatabaseGroupStore(GroupStore):
...
def database_group_store_factory(context):
    ...
    return DatabaseGroupStore(database, group_table, user_group_table)


def bootstrap(app):
    app.register_factory(database_group_store_factory, GroupStore)
